                ...
                <div class="col">
                    <form method="post">
                        <div class="row ">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="lessonName" class="form-control " id="colFormLabelSm" placeholder="">
                            </div>
                        </div>
                         <div class="row ">
                             <div class="col-sm-2"> </div>
                             <div class="col-sm-6"><input type="submit" value="Создать" class="students_btn2 "> </div>
                        </div>
                    </form>
